    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header">{{ __('Create New') }} <a href="{{route('employee.index')}}" class="btn btn-sm btn-primary">Back</a></div>

                <div class="card-body">
                    <form method="POST" action="{{ route('employee.update.name',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <br>
                    <form method="POST" action="{{ route('employee.update.email',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <form method="POST" action="{{ route('employee.update.password',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <form method="POST" action="{{ route('employee.update.mobile',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <form method="POST" action="{{ route('employee.update.designation',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <form method="POST" action="{{ route('employee.update.salary',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <form method="POST" action="{{ route('employee.update.address',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <form method="POST" action="{{ route('employee.update.role',[$employee->id]) }}">
                        @csrf
                        @method('PUT')
